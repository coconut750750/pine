...
var $author$project$Generated$Types$CodeSubmission = F3(
...
var $author$project$Generated$Encoder$encodeCodeSubmission = function (x) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'tag',
				$elm$json$Json$Encode$string('CodeSubmission')),
				_Utils_Tuple2(
				'count1',
				$elm$json$Json$Encode$int(x.count1)),
				_Utils_Tuple2(
				'count2',
				$elm$json$Json$Encode$int(x.count2)),
				_Utils_Tuple2(
				'text',
				$elm$json$Json$Encode$string(x.text))
			]));
};
...
var $author$project$Utils$CssUtils$calcDimension = F3(
	function (total, padding, border) {
		var edgeSize = A3(
			$rtfeldman$elm_css$Css$calc,
			A3($rtfeldman$elm_css$Css$calc, padding, $rtfeldman$elm_css$Css$plus, padding),
			$rtfeldman$elm_css$Css$plus,
			border);
		return A3($rtfeldman$elm_css$Css$calc, total, $rtfeldman$elm_css$Css$minus, edgeSize);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Run')
					]))
			]));
};
...
var $author$project$Main$onTab = function (msg) {
	...
	return A2(
		...
		A2(
			$elm$json$Json$Decode$map,
			function (x) {
				return {message: x, preventDefault: true, stopPropagation: true};
			},
			A2($elm$json$Json$Decode$andThen, isTabKey, $elm$html$Html$Events$keyCode)));
};
...
var $author$project$Main$mainInput = F2(
	function (attrs, code) {
		...
		var heightSize = A3(
			...
			paddingSize,
			$rtfeldman$elm_css$Css$px(0));
		var borderSize = $rtfeldman$elm_css$Css$px(0.125);
		var widthSize = A3(
			$author$project$Utils$CssUtils$calcDimension,
			$rtfeldman$elm_css$Css$pct(100),
			paddingSize,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							_Utils_Tuple2('repl', true)
						])),
					$rtfeldman$elm_css$Html$Styled$Attributes$css(
					_Utils_ap(
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$width(widthSize),
								$rtfeldman$elm_css$Css$height(heightSize),
...
var $author$project$Main$mainOutput = F2(
	function (attrs, output) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text(output)
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Css$height(headerHeight),
